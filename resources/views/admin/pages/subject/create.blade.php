              ...
              <div class="content-block">
                    <form action="{{route('subject.store')}}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input id="nameST" required class="form-control" type="text" value="{{old('name_id_subject')}}" name="name_id_subject"  placeholder="Mã môn học">
                      ...
                      <div class="form-group">
                        ...
                        <input id="nameST" required class="form-control" type="text" value="{{old('name')}}" name="name"  placeholder="Tên môn học">
                        @error('name')
                            <span class="messError">{{$message}}</span>
                        @enderror
                      ...
                      <div class="form-group">
                        ...
                        <input id="nameST" required class="form-control" type="text" value="{{old('credit')}}" name="credit"  placeholder="Tín chỉ môn học">
                        @error('credit')
                            <span class="messError">{{$message}}</span>
                        @enderror
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_semester" required id="id_semester" class="form-control">
                          ...
                          @foreach ($semester as $listSemester)
                            <option  value="{{$listSemester->id}}">{{$listSemester->name_id}}</option>
                          @endforeach
                        </select>
                        @error('id_semester')
                            <span class="messError">{{$message}}</span>
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_class" required id="id_class" class="form-control">
                          ...
                          @foreach ($class as $listClass)
                            <option  value="{{$listClass->id}}">{{$listClass->name_id}}</option>
                          @endforeach
                        </select>
                        @error('id_class')
                            <span class="messError">{{$message}}</span>
                      ...
                      <div class="form-group">
                        ...
                        <select name="subject_type" required id="subject_type" class="form-control">
                          ...
                          @foreach ($subjectType as $listSubjectType)
                            <option  value="{{$listSubjectType->id}}">{{$listSubjectType->type}}</option>
                          @endforeach
                        </select>
                        @error('subject_type')
                            <span class="messError">{{$message}}</span>
