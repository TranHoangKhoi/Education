    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="https://ap.poly.edu.vn/images/logo.png" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="https://ap.poly.edu.vn/images/logo.png" alt="logo" /></a>
        </div>
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Trần Hoàng Khôi</h5>
          ...
          <li class="nav-item nav-category">
            <span class="nav-link">Danh mục quản lý</span>
          </li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="stdent">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('student.index')}}">Danh sách sinh viên</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('student.create')}}">Thêm mới sinh viên</a></li>
                {{-- <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li> --}}
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#lectures" aria-expanded="false" aria-controls="lectures">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
            ...
            <div class="collapse" id="lectures">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('lecturers.index')}}">Danh sách giảng viên</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('lecturers.create')}}">Thêm mới giảng viên</a></li>
                {{-- <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li> --}}
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="admins">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('admins.index')}}">Danh sách giảng viên</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('admins.create')}}">Thêm mới giảng viên</a></li>
                {{-- <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li> --}}
              </ul>
            </div>
          </li>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    {{-- <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt=""> --}}
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Trần Hoàng Khôi</p>
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Team Diamond</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Design <a href="https://www.facebook.com/profile.php?id=100014806060356" target="_blank">Template</a> from Tran Hoang Khoi</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
